...
model_path = 'H:/Deep Learning/Pest and Insect Detection/Vision Transformer integrated with ML models/ViT_SVM_model_augmented_data.pkl'
...
# Save the trained model using joblib
model_path = 'H:/Deep Learning/Pest and Insect Detection/Vision Transformer integrated with ML models/ViT_SVM_model.pkl'
joblib.dump(svm_classifier, model_path)
print(f"Model saved to {model_path}")
